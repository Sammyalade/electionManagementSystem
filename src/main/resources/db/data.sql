...
truncate table registered_candidates cascade;
...
(2,	'1/1/1990'	,'ELIGIBLE',	'InitialFirstName',	'InitialLastName',	'initialpassword',	'initialuser1'	),
(3,	'1/1/1990'	,'ELIGIBLE',	'InitialFirstName',	'InitialLastName',	'initialpassword',	'initialuser'	);
...
insert into candidates(date_of_birth, id, biography, financial_disclosure_url, nomination_form_url, party_affiliation, password, position_contested, username) values
    (	'6/21/2002'	, 1 ,'biography','http://res.cloudinary.com/dbjtncfmz/image/upload/v1718984758/bexm1vaipwdzkupz8xci.pdf'	,'http://res.cloudinary.com/dbjtncfmz/image/upload/v1718984729/zl2uxpntxndetxrquhn1.pdf	','affiliacion1'	,'1234'	,'presido'	,'jargoh');

insert into candidates(date_of_birth, id, biography, financial_disclosure_url, nomination_form_url, party_affiliation, password, position_contested, username) values
    (	'6/21/2001'	, 2 ,'biography','http://res.cloudinary.com/dbjtncfmz/image/upload/v1718984758/bexm1vaipwdzkupz8xci.pdf'	,'http://res.cloudinary.com/dbjtncfmz/image/upload/v1718984729/zl2uxpntxndetxrquhn1.pdf	','affiliacion2'	,'1234'	,'presido'	,'jargohWire');


insert into election (id, election_category,	election_status,	election_title,	end_time,	start_time)values
(1	,'PRESIDENTIAL',	'SCHEDULED',	'millionaire',	'7/20/2024 0:00',	'6/23/2024 1:26');
